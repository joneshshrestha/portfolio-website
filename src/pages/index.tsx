...
const featuredProjects = [
  {
    ...
    description:
      'A responsive portfolio website built with Gatsby, React, and Tailwind CSS.',
  ...
  },
  {
    title: 'Backroads App',
    description:
      'A travel website showcasing various tour packages and destinations.',
        ...
        <section>
          ...
          <div className='bio mt-8'>
            <p className='text-base leading-relaxed text-gray-700 dark:text-gray-300'>
              I thrive on transforming ideas into tangible, functional
              realities, growing and learning in this ever-evolving tech
              landscape.
            </p>
          </div>
...
export const Head = () => <title>Jonesh Shrestha - Software Engineer</title>
