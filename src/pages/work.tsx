...
const workExperiences = [
  ...
  {
    company: 'Thoplo Technology Pvt. Ltd',
    companyUrl: 'https://thoplo.com/',
    logo: '/img/thoplo.jpg',
    role: 'Frontend Developer: Crafted bilingual website, excelling in transliteration and Vanilla JavaScript conversions.',
  },
  {
  ...
  {
    company: 'OpenMyNetwork',
    companyUrl: 'https://openmynetwork.com/',
    logo: '/img/openmynetwork-logo.png',
    role: 'Startup Intern: Social media engagement, game development, mobile app prototypes.',
  },
  {
