...
**[→ View Notebook on GitHub](https://github.com/joneshshrestha/machine-learning-python/blob/main/Clustering/customer-segmentation/customer-segmentation.ipynb)**

You can also run it interactively:

- [Open in Google Colab](https://colab.research.google.com/github/joneshshrestha/machine-learning-python/blob/main/Clustering/customer-segmentation/customer-segmentation.ipynb)
- [Open in Binder](https://mybinder.org/v2/gh/joneshshrestha/machine-learning-python/main?filepath=Clustering/customer-segmentation/customer-segmentation.ipynb)
