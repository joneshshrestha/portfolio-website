...
**[→ View Notebook on GitHub](https://github.com/joneshshrestha/machine-learning-python/blob/main/Classification/customer-churn-prediction/telecom-customer-churn-prediction.ipynb)**

You can also run it interactively:

- [Open in Google Colab](https://colab.research.google.com/github/joneshshrestha/machine-learning-python/blob/main/Classification/customer-churn-prediction/telecom-customer-churn-prediction.ipynb)
- [Open in Binder](https://mybinder.org/v2/gh/joneshshrestha/machine-learning-python/main?filepath=Classification/customer-churn-prediction/telecom-customer-churn-prediction.ipynb)
